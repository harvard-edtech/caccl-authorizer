        ...
        switch (_a.label) {
            case 0:
                ...
                scopesQueryAddon = (opts.scopes
                    ? "&scope=".concat(encodeURIComponent(opts.scopes.join(' ')))
                    : '');
            ...
            case 1:
                ...
                opts.app.get(CACCL_PATHS_1.default.AUTHORIZE, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
                    var _a, launched, launchInfo, tokenPack, err_2, devCreds, appHost, authURL;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _a = (0, caccl_lti_1.getLaunchInfo)(req), launched = _a.launched, launchInfo = _a.launchInfo;
                            ...
                            case 5:
                                ...
                                appHost = (thisIsDevEnvironment
                                    ? 'localhost:8080'
                                    : req.hostname);
                                authURL = "https://".concat(launchInfo.canvasHost, "/login/oauth2/auth?client_id=").concat(devCreds.clientId, "&response_type=code&redirect_uri=https://").concat(appHost).concat(CACCL_PATHS_1.default.AUTHORIZE, "&state=caccl").concat(scopesQueryAddon);
