...
// Import token store
var MemoryTokenStore_js_1 = __importDefault(require("./MemoryTokenStore.js"));
// Import shared types
...
var refreshAuth = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, launched, launchInfo, tokenPack, body, expiresIn, newTokenPack, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, tokenStore.get(launchInfo.canvasHost, launchInfo.userId)];
            case 1:
                tokenPack = _b.sent();
                if (!tokenPack) {
                    throw new caccl_error_1.default({
            ...
            case 3:
                ...
                // Save in the store
                return [4 /*yield*/, tokenStore.set(launchInfo.canvasHost, launchInfo.userId, newTokenPack)];
            case 4:
                // Save in the store
                _b.sent();
...
var initAuth = function (opts) {
    ...
    // Initialize scopes
    var scopesQueryAddon = (opts.scopes
        ? "&scopes=".concat(encodeURIComponent(opts.scopes.join(' ')))
        : undefined);
    // Initialize token store
    tokenStore = (opts.tokenStore
        ? opts.tokenStore
        : new MemoryTokenStore_js_1.default());
    ...
    opts.app.get(CACCL_PATHS_1.default.AUTHORIZE, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    authURL = "https://".concat(launchInfo.canvasHost, "/login/oauth2/auth?client_id=").concat(opts.developerCredentials.client_id, "&response_type=code&redirect_uri=https://").concat(req.hostname).concat(CACCL_PATHS_1.default.AUTHORIZE, "&state=caccl").concat(scopesQueryAddon);
