...
var MemoryTokenStore = /** @class */ (function () {
     ...
     */
    MemoryTokenStore.prototype.get = function (canvasHost, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var hostStore;
            return __generator(this, function (_a) {
                hostStore = this.store.get(canvasHost);
                if (!hostStore) {
                    return [2 /*return*/, undefined];
                }
                // Look up by id
                return [2 /*return*/, (hostStore.get(userId) || undefined)];
            });
        });
    };
    /**
     ...
     */
    MemoryTokenStore.prototype.set = function (canvasHost, userId, tokenPack) {
        return __awaiter(this, void 0, void 0, function () {
            var hostStore;
            return __generator(this, function (_a) {
                hostStore = this.store.get(canvasHost);
...
exports.default = MemoryTokenStore;
//# sourceMappingURL=MemoryTokenStore.js.map